(function() {
    ...
    const DAY_MOUNTAINS = {
        distant: {
            gradient: { id: 'mtn-distant-grad', stops: [
                { offset: '0%', color: '#b8c8d8' },
                { offset: '30%', color: '#98b0c8' },
                { offset: '60%', color: '#7898b8' },
                { offset: '100%', color: '#5880a8' }
            ]},
            shadowGradient: { id: 'mtn-distant-shadow', stops: [
                { offset: '0%', color: '#8a9aaa' },
                { offset: '100%', color: '#5a7090' }
            ]}
        },
        mid: {
            gradient: { id: 'mtn-mid-grad', stops: [
                { offset: '0%', color: '#6888a0' },
                { offset: '35%', color: '#547890' },
                { offset: '70%', color: '#406880' },
                { offset: '100%', color: '#305870' }
            ]},
            shadowGradient: { id: 'mtn-mid-shadow', stops: [
                { offset: '0%', color: '#4a6078' },
                { offset: '100%', color: '#284860' }
            ]},
            highlightGradient: { id: 'mtn-mid-highlight', stops: [
                { offset: '0%', color: '#8aa8c0' },
                { offset: '100%', color: '#6888a0' }
            ]}
        },
        foreground: {
            gradient: { id: 'mtn-near-grad', stops: [
                { offset: '0%', color: '#456078' },
                { offset: '40%', color: '#354d60' },
                { offset: '100%', color: '#203848' }
            ]},
            shadowGradient: { id: 'mtn-near-shadow', stops: [
                { offset: '0%', color: '#304858' },
                { offset: '100%', color: '#152838' }
            ]},
            highlightGradient: { id: 'mtn-near-highlight', stops: [
                { offset: '0%', color: '#5a7890' },
                { offset: '100%', color: '#456078' }
            ]}
        },
        close: {
            gradient: { id: 'mtn-close-grad', stops: [
                { offset: '0%', color: '#254055' },
                { offset: '50%', color: '#152838' },
                { offset: '100%', color: '#0a1825' }
            ]}
        }
    };

    const NIGHT_MOUNTAINS = {
        distant: {
            gradient: { id: 'mtn-distant-grad', stops: [
                { offset: '0%', color: '#1a2840' },
                { offset: '30%', color: '#162235' },
                { offset: '60%', color: '#121c2c' },
                { offset: '100%', color: '#0e1824' }
            ]},
            shadowGradient: { id: 'mtn-distant-shadow', stops: [
                { offset: '0%', color: '#0e1820' },
                { offset: '100%', color: '#0a1218' }
            ]}
        },
        mid: {
            gradient: { id: 'mtn-mid-grad', stops: [
                { offset: '0%', color: '#121e30' },
                { offset: '35%', color: '#0e1828' },
                { offset: '70%', color: '#0a1420' },
                { offset: '100%', color: '#081018' }
            ]},
            shadowGradient: { id: 'mtn-mid-shadow', stops: [
                { offset: '0%', color: '#0a1218' },
                { offset: '100%', color: '#060c12' }
            ]},
            highlightGradient: { id: 'mtn-mid-highlight', stops: [
                { offset: '0%', color: '#2a4868' },
                { offset: '100%', color: '#1a3050' }
            ]}
        },
        foreground: {
            gradient: { id: 'mtn-near-grad', stops: [
                { offset: '0%', color: '#0c1a28' },
                { offset: '40%', color: '#081420' },
                { offset: '100%', color: '#040c14' }
            ]},
            shadowGradient: { id: 'mtn-near-shadow', stops: [
                { offset: '0%', color: '#060e18' },
                { offset: '100%', color: '#02080f' }
            ]},
            highlightGradient: { id: 'mtn-near-highlight', stops: [
                { offset: '0%', color: '#1e3c58' },
                { offset: '100%', color: '#0e2238' }
            ]}
        },
        close: {
            gradient: { id: 'mtn-close-grad', stops: [
                { offset: '0%', color: '#070f18' },
                { offset: '50%', color: '#04090f' },
                { offset: '100%', color: '#020508' }
            ]}
        }
    };
    ...
    const CLOUDS = {
        ...
        clouds: [
            { classList: 'cloud cloud-1', filter: 'cloud-soft', path: 'M 80,120 C 72,108 78,95 90,92 C 88,78 96,66 110,64 C 114,52 126,44 140,48 C 148,38 162,40 168,50 C 176,44 190,48 192,60 C 204,58 212,70 206,82 C 216,86 216,100 205,105 L 85,110 C 70,108 74,117 80,120 Z', fill: 'rgba(255,255,255,0.78)' },
            { classList: 'cloud cloud-2', filter: 'cloud-soft', path: 'M 760,95 C 754,85 760,75 772,72 C 770,62 778,52 790,54 C 794,44 806,40 818,46 C 824,38 838,40 844,50 C 855,48 862,58 858,70 C 868,72 870,88 860,95 L 768,98 C 754,96 758,90 760,95 Z', fill: 'rgba(255,255,255,0.68)' },
            { classList: 'cloud cloud-3', filter: 'cloud-soft-sm', path: 'M 380,110 C 376,102 382,94 392,92 C 394,82 402,76 414,78 C 418,70 430,68 440,74 C 446,68 458,72 460,82 C 470,82 478,92 472,102 C 482,106 480,118 470,122 L 388,120 C 378,118 382,112 380,110 Z', fill: 'rgba(255,255,255,0.58)' },
            { classList: 'cloud cloud-4', filter: 'cloud-soft', path: 'M 1080,88 C 1074,78 1082,68 1094,66 C 1092,56 1100,46 1114,48 C 1118,38 1134,35 1150,42 C 1158,34 1174,38 1180,50 C 1192,48 1202,60 1196,72 C 1208,76 1210,92 1198,98 L 1092,100 C 1078,98 1082,90 1080,88 Z', fill: 'rgba(255,255,255,0.62)' },
            { classList: 'cloud cloud-5', filter: 'cloud-soft-sm', path: 'M 1280,132 C 1278,125 1284,118 1292,118 C 1294,110 1302,105 1312,108 C 1316,102 1328,100 1336,106 C 1342,100 1354,104 1356,112 C 1366,112 1372,122 1366,130 C 1374,134 1372,146 1362,148 L 1288,146 C 1280,144 1282,138 1280,132 Z', fill: 'rgba(255,255,255,0.48)' }
        ]
    };
    ...
    function getPalette() {
        return isDark() ? NIGHT_MOUNTAINS : DAY_MOUNTAINS;
    }
    ...
    function generateDistantMountains() {
        ...
        const pal = getPalette().distant;
        const night = isDark();
        const svg = createSVG({ class: data.classList, viewBox: data.viewBox, preserveAspectRatio: 'none' });
        svg.appendChild(createDefs([pal.gradient, pal.shadowGradient]));
        svg.appendChild(createPath(data.path, `url(#${pal.gradient.id})`));
        data.shadowPaths.forEach(p => svg.appendChild(createPath(p, `url(#${pal.shadowGradient.id})`, { opacity: '0.4' })));
        const hlColor = night ? 'rgba(100,170,230,0.18)' : 'rgba(255,255,255,0.15)';
        data.highlightPaths.forEach(p => svg.appendChild(createPath(p, hlColor, { opacity: '0.5' })));
        return svg;
    }

    function generateMidMountains() {
        const data = MOUNTAINS.mid;
        const pal = getPalette().mid;
        const night = isDark();
        const svg = createSVG({ class: data.classList, viewBox: data.viewBox, preserveAspectRatio: 'none' });
        svg.appendChild(createDefs([pal.gradient, pal.shadowGradient, pal.highlightGradient]));
        svg.appendChild(createPath(data.path, `url(#${pal.gradient.id})`));
        data.shadowPaths.forEach(p => svg.appendChild(createPath(p, `url(#${pal.shadowGradient.id})`, { opacity: '0.45' })));
        data.highlightPaths.forEach(p => svg.appendChild(createPath(p, `url(#${pal.highlightGradient.id})`, { opacity: night ? '0.5' : '0.35' })));
        const forestStroke = night ? 'rgba(2,6,10,0.8)' : 'rgba(30,50,65,0.5)';
        svg.appendChild(createPath(data.forestLine, 'none', { stroke: forestStroke, 'stroke-width': '10', 'stroke-linecap': 'round', opacity: '0.55' }));
        return svg;
    }

    function generateForegroundMountains() {
        const data = MOUNTAINS.foreground;
        const pal = getPalette().foreground;
        const night = isDark();
        const svg = createSVG({ class: data.classList, viewBox: data.viewBox, preserveAspectRatio: 'none' });
        svg.appendChild(createDefs([pal.gradient, pal.shadowGradient, pal.highlightGradient]));
        svg.appendChild(createPath(data.path, `url(#${pal.gradient.id})`));
        data.shadowPaths.forEach(p => svg.appendChild(createPath(p, `url(#${pal.shadowGradient.id})`, { opacity: '0.5' })));
        data.highlightPaths.forEach(p => svg.appendChild(createPath(p, `url(#${pal.highlightGradient.id})`, { opacity: night ? '0.5' : '0.3' })));
        const forestStroke = night ? 'rgba(1,4,8,0.9)' : 'rgba(15,30,45,0.6)';
        svg.appendChild(createPath(data.forestLine, 'none', { stroke: forestStroke, 'stroke-width': '14', 'stroke-linecap': 'round', opacity: '0.65' }));
        return svg;
    }

    function generateCloseMountains() {
        const data = MOUNTAINS.close;
        const pal = getPalette().close;
        const night = isDark();
        const svg = createSVG({ class: data.classList, viewBox: data.viewBox, preserveAspectRatio: 'none' });
        svg.appendChild(createDefs([pal.gradient]));
        svg.appendChild(createPath(data.path, `url(#${pal.gradient.id})`));
        const forestStroke = night ? 'rgba(0,2,5,1)' : 'rgba(5,15,25,0.7)';
        svg.appendChild(createPath(data.forestDetail, 'none', { stroke: forestStroke, 'stroke-width': '22', 'stroke-linecap': 'round', opacity: night ? '1' : '0.85' }));
        return svg;
    }

    function generateClouds() {
        const svg = createSVG({ class: 'clouds-svg', viewBox: CLOUDS.viewBox, preserveAspectRatio: 'xMidYMid slice' });
        const defs = document.createElementNS('http://www.w3.org/2000/svg', 'defs');
        [{ id: 'cloud-soft', stdDeviation: '5' }, { id: 'cloud-soft-sm', stdDeviation: '3' }].forEach(f => {
